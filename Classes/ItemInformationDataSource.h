...
class ItemInformationDataSource{
    ...
    public:
        ...
        std::string getPictureDir(int atIndex){ return "collections/" + setName + "/" + getName(atIndex) + ".png"; }
        std::string getNamePictureDir(int atIndex){return "collections/" + setName + "/" + getName(atIndex) + "_Name.png";}
